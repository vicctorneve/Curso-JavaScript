...
function () {
  ...
  _createClass(GeraCPF, [{
    ...
    key: "geraNewCpf",
    value: function geraNewCpf() {
      var cpfSemDigito = this.rand();
      var digito1 = _ValidaCPF__WEBPACK_IMPORTED_MODULE_0__["default"].createDigite(cpfSemDigito);
      var digito2 = _ValidaCPF__WEBPACK_IMPORTED_MODULE_0__["default"].createDigite(cpfSemDigito + digito1);
...
function () {
  ...
  _createClass(ValidaCPF, [{
    ...
    value: function valida() {
      ...
      var digit1 = ValidaCPF.createDigite(cpfParcial);
      var digit2 = ValidaCPF.createDigite(cpfParcial + digit1);
      var newCpf = cpfParcial + digit1 + digit2;
      return newCpf === this.cpfLimpo;
    }
  }], [{
    key: "createDigite",
    value: function createDigite(cpfParcial) {
      var cpfArray = Array.from(cpfParcial);
      var regressive = cpfArray.length + 1;
      var total = cpfArray.reduce(function (ac, valor) {
